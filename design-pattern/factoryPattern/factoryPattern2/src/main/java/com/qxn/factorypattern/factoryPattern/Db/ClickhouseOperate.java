 ...
 */
@Component
public class ClickhouseOperate extends CommonOperate {

    /**
     * @Field operateCode : 数据库编码
     */
    private String operateCode = "ck";

    /**
     * @Field operateName : 数据库名称
     */
    private String operateName = "clickhouse";
    ...
    public void addOneData(TableDataOperateVo vo) {
        ...
        System.out.println("ck添加表: " + tableName);
    }
    ...
    public void updateOneData(TableDataOperateVo vo) {
        ...
        String tableName = vo.getTableName();
        System.out.println("ck更新表: " + tableName);
    }
